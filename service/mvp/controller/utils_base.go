...
//
//	enjoyExpense := getExpense(desk.Space.Price, desk.StartTimestamp, desk.EndTimestamp)
//	deskExpense := model.GetFavorExpense(enjoyExpense, desk.Favors)
...
//		goodExpense := model.GetFavorExpense(nonFavorExpense, good.Favors)
...
func getElementsExpense(elements []*pb.Element) float64 {
	expense := 0.0
