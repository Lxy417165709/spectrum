...
var file_common_pb_mvp_proto_rawDesc = []byte{
	...
	0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x08, 0x2e, 0x70, 0x62, 0x2e, 0x47, 0x6f, 0x6f,
	0x64, 0x52, 0x05, 0x67, 0x6f, 0x6f, 0x64, 0x73, 0x32, 0xee, 0x05, 0x0a, 0x03, 0x4d, 0x76, 0x70,
	...
	0x6c, 0x47, 0x6f, 0x6f, 0x64, 0x73, 0x52, 0x65, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_common_pb_mvp_proto_msgTypes = make([]protoimpl.MessageInfo, 30)
...
var file_common_pb_mvp_proto_depIdxs = []int32{
	...
	1,  // 19: pb.Mvp.AddGood:output_type -> pb.AddGoodRes
	5,  // 20: pb.Mvp.AddBilliardDesk:output_type -> pb.AddBilliardDeskRes
	3,  // 21: pb.Mvp.SellGood:output_type -> pb.SellGoodRes
	7,  // 22: pb.Mvp.BeginPlayBilliard:output_type -> pb.BeginPlayBilliardRes
	9,  // 23: pb.Mvp.StopPlayBilliard:output_type -> pb.StopPlayBilliardRes
	14, // 24: pb.Mvp.Order:output_type -> pb.OrderRes
	16, // 25: pb.Mvp.GetOrderGoods:output_type -> pb.GetOrderGoodsRes
	18, // 26: pb.Mvp.AddGoodType:output_type -> pb.AddGoodTypeRes
	20, // 27: pb.Mvp.Checkout:output_type -> pb.CheckoutRes
	22, // 28: pb.Mvp.AddOptionClass:output_type -> pb.AddOptionClassRes
	24, // 29: pb.Mvp.GetAllOptionClasses:output_type -> pb.GetAllOptionClassesRes
	27, // 30: pb.Mvp.DelOption:output_type -> pb.DelOptionRes
	29, // 31: pb.Mvp.GetAllGoods:output_type -> pb.GetAllGoodsRes
